  ...
  return (
    ...
    >
      <div className="p-6 md:p-8 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-wrap gap-2">
              {project.focus.map((tag) => (
                <span
                  key={tag}
                  className="font-mono text-[10px] text-engrave-fresco border border-stone-anthracite/40 px-2 py-1"
                >
                  {tag}
                </span>
              ))}
        ...
        {/* CTA */}
        <div className="pt-4 border-t border-stone-anthracite/20 flex flex-wrap gap-3">
            ...
            <>
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 px-4 py-2 border border-stone-anthracite/30 bg-ink-deep/50
                         ...
                         font-mono text-xs text-engrave-fresco tracking-wider group/link"
              >
                {t('presentation.investmentPresentation')}
                <ExternalLink size={12} className="group-hover/link:translate-x-0.5 group-hover/link:-translate-y-0.5 transition-transform" />
              </Link>
            </>
          ) : project.id === 'tradeplus' ? (
            <Link
              href="/projects/tradeplus/presentation"
              className="inline-flex items-center gap-2 px-4 py-2 border border-stone-anthracite/30 bg-ink-deep/50
                       hover:border-engrave-line/50 hover:bg-engrave-line/10 transition-all
                       font-mono text-xs text-engrave-fresco tracking-wider group/link"
            >
          ...
          ) : project.id === 'dogymorbios' ? (
            <Link
              href="/projects/dogymorbios/presentation"
              className="inline-flex items-center gap-2 px-4 py-2 border border-stone-anthracite/30 bg-ink-deep/50
                       hover:border-engrave-line/50 hover:bg-engrave-line/10 transition-all
                       font-mono text-xs text-engrave-fresco tracking-wider group/link"
            >
          ...
          ) : project.id === 'nexusvita' ? (
            <Link
              href="/projects/nexusvita/presentation"
              className="inline-flex items-center gap-2 px-4 py-2 border border-stone-anthracite/30 bg-ink-deep/50
                       hover:border-engrave-line/50 hover:bg-engrave-line/10 transition-all
                       font-mono text-xs text-engrave-fresco tracking-wider group/link"
            >
