  ...
  solutions: {
    ...
    services: [
      ...
      },
      {
        ...
        description: 'Development of decentralized applications and integration with blockchain technologies. Smart contracts, DeFi protocols, NFT platforms and DAO systems with security audit and tokenomics development.',
        features: [
          'Smart contracts',
          'DeFi applications',
          'NFT platforms',
      ...
      },
      {
        ...
        subtitle: 'Traffic & Conversion Engineering',
        description: 'Comprehensive digital product and brand promotion in online space. Marketing strategy, funnels setup, CRM integration and process automation for maximum business efficiency.',
        features: [
          'Marketing strategy',
      ...
      {
        id: 'gamedev',
        title: 'GAMEDEV & GAMIFICATION',
        subtitle: 'Interactive Engagement Systems',
        description: 'Game development and game mechanics for user engagement and training. Mobile and web games, business process gamification, training simulators and VR/AR solutions.',
        features: [
      ...
      description: 'Комплексные решения формируются через глубокую интеграцию IT, архитектуры, дизайна, кинематографа и научных исследований. Каждая задача рассматривается с множества углов зрения, что открывает нестандартные подходы и позволяет создавать продукты, недоступные в рамках одной дисциплины. Мультидисциплинарный многоуровневый подход становится инструментом поиска уникальных и оптимальных решений для каждого проекта.',
        services: [
          ...
          },
          {
            ...
            subtitle: 'Децентрализованная Архитектура',
            description: 'Разработка децентрализованных приложений и интеграция с блокчейн технологиями. Смарт-контракты, DeFi протоколы, NFT платформы и DAO системы с аудитом безопасности и разработкой токеномики.',
            features: [
              'Smart-контракты',
              'DeFi приложения',
              'NFT платформы',
          ...
          },
          {
            ...
            subtitle: 'Инженерия Трафика и Конверсий',
            description: 'Комплексное продвижение цифровых продуктов и брендов в онлайн-пространстве. Маркетинговая стратегия, настройка воронок, интеграция CRM и автоматизация процессов для максимальной эффективности бизнеса.',
            features: [
          ...
          },
          {
            ...
            subtitle: 'Интерактивные Системы Вовлечения',
            description: 'Разработка игр и игровых механик для вовлечения пользователей и обучения. Мобильные и веб игры, геймификация бизнес-процессов, обучающие симуляторы и VR/AR решения.',
            features: [
