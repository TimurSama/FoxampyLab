        ...
        <>
          ...
          >
            <div className="p-4 md:p-8 lg:p-12">
              <button
                onClick={onClose}
                className="absolute top-6 right-6 text-[#E0E0E0] hover:text-[#FFFFFF] transition-colors"
              >
                <X size={24} />
              </button>
              ...
              {service.features && service.features.length > 0 && (
                <div className="mb-8">
                  <h3 className="font-mono text-lg text-[#E0E0E0] mb-4">Ключевые возможности:</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {service.features.map((feature, i) => (
                      <div
                        key={i}
                        className="border border-[#E0E0E0]/20 bg-[#E0E0E0]/5 p-3"
                      >
