...
float fluidWave(vec2 uv, float time) {
    vec2 flow1 = vec2(
        fbm(uv * 0.5 + vec2(time * 0.35, time * 0.4)),
        fbm(uv * 0.5 + vec2(time * 0.38, time * 0.43))
    );
    
    float wave1 = fbm(uv * 1.2 + flow1 * 3.0 + vec2(time * 0.45, time * 0.5));
    float wave2 = fbm(uv * 1.8 - flow1 * 2.5 + vec2(time * 0.5, time * 0.55));
    float wave3 = fbm(uv * 2.5 + flow1 * 3.5 + vec2(time * 0.55, time * 0.6));
...
export default function InkFluidVariant6() {
